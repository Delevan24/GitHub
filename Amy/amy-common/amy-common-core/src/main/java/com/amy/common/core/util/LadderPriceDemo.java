...
public class LadderPriceDemo {
    public static void main(String[] args) {
        ...
        List<BigDecimal> vol = new LinkedList<>();
     ...
     * @return
     */
    public static BigDecimal getMoney(BigDecimal cycNum, BigDecimal useNum, List<BigDecimal> price, List<BigDecimal> vol) {
        return getMoney(cycNum.add(useNum), price, vol).subtract(getMoney(cycNum, price, vol));
    }
     ...
     * @return
     */
    private static BigDecimal getMoney(BigDecimal num, List<BigDecimal> price, List<BigDecimal> vol1) {
